...
<head>
    ...
    <link rel="stylesheet" href="../css/profils.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="../css/livre-or.css" rel="stylesheet" type="text/css">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link" href="livre-or.php">Livre d'or</a>
                </div>
            </div>
        </nav>
    </header>